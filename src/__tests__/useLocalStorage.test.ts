...
describe("useLocalStorage", () => {
  ...
  it("should handle TTL expiration", () => {
    ...
    const { result } = renderHook(() =>
      useLocalStorage("test-key", "initial", { ttl: 5000 })
    );
...
describe("useLocalStorageArray", () => {
  ...
  it("should add items to array", () => {
    const { result } = renderHook(() =>
      useLocalStorageArray<string>("test-array", [])
    );
  ...
  it("should clear array", () => {
    const { result } = renderHook(() =>
      useLocalStorageArray("test-array", ["item1"])
    );
...
describe("useLocalStorageObject", () => {
  ...
  it("should initialize with default object", () => {
    ...
    const { result } = renderHook(() =>
      useLocalStorageObject("test-obj", defaultObj)
    );
